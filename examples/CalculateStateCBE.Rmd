...
```{r cbe_results, echo=FALSE, results='hide', fig.keep='all', fig.height=4, fig.width=6.5, message=FALSE, warning=FALSE}
p_list <- c()
for(y in years) {
  col <- paste0(state, "-", y)
...
Text goes here to describe 

```{r time_series_demand, echo=FALSE, fig.width=6.5, fig.height=4, fig.cap=c("This is my first caption", "This is my second caption")}
...
```{r ghg_time_series, echo=FALSE, fig.width=6.5, fig.height=8.5, fig.cap=c("This is my first caption", "This is my second caption")}
...
```{r cbe_territorial, echo=FALSE, fig.width=6.5, fig.height=4, fig.cap="this is my caption"}
