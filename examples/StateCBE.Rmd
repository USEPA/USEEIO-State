...
```{r cbeterritorial, echo=FALSE, fig.width=6.5, fig.height=4, fig.cap="Comparison of consumption-based and territorial GHG emissions. MMT CO2e = Million Metric Tons CO2e-equivalent GHG emissions." }
