...
params:
  model:
    ...
    value: "v1.1-GHG"
    input: select
    choices: ["v1.1-GHG","v1.1-GHGc","v1.3-pecan"]
  years:
    label: "Model Year"
    value: [2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020]
    input: select
    multiple: TRUE
    choices: [2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022]
  state:
    label: "State"
    value: ""
    input: select
...
} else if (spec == "v1.3-pecan") {
  modelstub <- 'EEIOv1.3-pecan-'
...
if (params$saveresultdata) {
  suffix <- paste0(state,"_",min(years),"-",max(years),".csv")
